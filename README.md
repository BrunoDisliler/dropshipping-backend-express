...
Desenvolver sua primeira API utilizando a arquitetura MSC (model-service-controller)!
...
# Requisitos Obrigatórios Propostos para realização do Projeto da Trybe
